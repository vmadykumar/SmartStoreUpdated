...
%msbuild% SmartStoreNET.proj /p:SlnName=SmartStoreNET /m /p:PublishDir=C:\Jenkins\workspace\SmartStore\Artifacts /p:DeployOnBuild=true /p:DeployDefaultTarget=WebPublish /p:WebPublishMethod=FileSystem /p:SkipInvalidConfigurations=true /t:build /p:Configuration=Release /p:DebugSymbols=true /p:DebugType=None /maxcpucount %*
