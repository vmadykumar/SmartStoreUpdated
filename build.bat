...
%msbuild% SmartStoreNET.proj /p:SlnName=SmartStoreNET /m /p:PublishDir=C:\Jenkins\workspace\SmartStore\Artifacts /t:build /p:Configuration=Release /p:DebugSymbols=true /p:DebugType=None /maxcpucount %*
