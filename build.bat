...
%msbuild% SmartStoreNET.proj /p:SlnName=SmartStoreNET /m /t:build /p:Configuration=Release /P:DeployOnBuild=True /p:AllowUntrustedCertificate=True /p:MSDeployServiceUrl=<172.30.11.7> /P:DeployIISAppPath=\"Default Web Site/PrimeDotnet\" /p:DebugSymbols=true /p:DebugType=None /maxcpucount %*
